      ...
      <div class="p-4 flex-1 flex flex-col justify-between">
        <div class="flex justify-between items-center mb-2">
          <div class="w-6 h-6 rounded-full">
            {item.platform == "nano_banana" && (
              <img src="https://img.icons8.com/?size=100&id=iBkBIBWE6tfT&format=png&color=000000" />
            )}
            {item.platform == "chat_gpt" && (
              <img src="https://img.icons8.com/?size=100&id=FBO05Dys9QCg&format=png&color=000000" />
            )}
          </div>
        ...
        <p class="text-sm text-gray-600 mt-1 line-clamp-3">{item.prompt}</p>
      </div>
    </div>
  );
}
